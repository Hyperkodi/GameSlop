...
export function ultimate(r){if(r.state!=='playing'||r.charge<100)return false;
 ...
 if(id==='wave'){fx(r,{type:'sweep',y:-40,speed:900,amount,weapon:best.id,hits:[],color:'#9ceaff',life:1.1});r.headDistance=Math.max(CAMPAIGN_ENTRY,r.headDistance-200);for(const s of r.segments)s.retreat=0;updatePositions(r);}
