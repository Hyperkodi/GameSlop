...
function renderHome(){
 ...
 ['burn','Easy. Hard. Impossible.','Clear Easy to unlock the next chapter and Hard on that level. Clear Hard to unlock Impossible. Higher difficulties give more starting bonuses, tougher snakes and larger victory rewards.'],
...
window.slopSurvivor={snapshot:()=>JSON.parse(JSON.stringify({run,save,storageOK,dialog})),version:'2.0.0'};
