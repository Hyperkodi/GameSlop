...
for name in ('index.html','app.js','style.css','title.js','engine.html','engine.js','engine.css','credits.html','game-manifest.json'):
    shutil.copyfile(LOCAL/name,PUBLIC/name)
for name in ('art/icon.jpg','art/stamp-hand-matte.png','data/gameslop.z64'):
